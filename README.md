...
[![GitHub commits since latest release (by SemVer including pre-releases)](https://img.shields.io/github/commits-since/Tatsh/livecheck/v0.1.4/master)](https://github.com/Tatsh/livecheck/compare/v0.1.4...master)
